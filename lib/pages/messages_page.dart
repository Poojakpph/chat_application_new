                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      ...
                      style: const TextStyle(letterSpacing: 0.2, wordSpacing: 1.5, fontWeight: FontWeight.w900),
                      ),
                  ),
                  SizedBox(
                    height: 20,
                ...
                child: Column(
                 ...
                 crossAxisAlignment: CrossAxisAlignment.end,
                  children: [
                    ...
                    Text(
                      messageData.dataMessage.toUpperCase(),
    ...
    return Card(
      ...
      child: SizedBox(
        ...
        const Padding(
          ...
          child: Text(
            'Stories',
            style: TextStyle(fontWeight: FontWeight.w900, fontSize: 15, color: AppColors.textFaded),
